...
| `policy-form.png` | Policy form + what OpenAI would receive | Landscape card: left = engagement fields, right = abstracted policy preview. Same content as the UI, sized for article scroll. |
